    ...
    return [
      ...
      },
      {
        ...
        pasos: [
          ...
          "Under each A4/A3 there are two buttons: red (sold out) and orange (the stand's sample is missing). Mark them per size if needed.",
      ...
      },
      {
        ...
        pasos: [
          ...
          "Sales: SumUp (card), cash counted at the end (count EVERYTHING in the pocket, float included: the app subtracts the float for you, and it can go negative if it wasn't covered) and PayPal.",
      ...
      },
      {
        ...
        pasos: [
          ...
          "Next to the mic, pick the language you'll speak in (EN, HI, TE, ES, DE, IT, CA): use your native language, whatever feels natural. We translate it.",
          "Tap 'Send feedback'. Done: it goes straight to Marcello and Nuria.",
          "Your feedback shows in the list below: tap the pencil to edit one if something was missing.",
        ],
      ...
      },
      {
        ...
        pasos: [
          ...
          "Personal tab: each admin sees only their own markets (Marcello sees Mauerpark, Nuria sees RAW), with the history of each closing and its breakdown. Private.",
      ...
      },
      {
        ...
        pasos: [
          "Active: recurring maintenance tasks, they never end (completing one schedules the next date and shows when it's back). One-off: single-use tasks.",
          "In both lists the most recent is on top and overdue ones at the bottom. Create one with the green button.",
          "Each task has a difficulty: simple 1 col, medium 2, complex 3 or 4 (based on complexity and hours).",
          "Tap the pencil on a task to edit it (name, frequency, difficulty, assignee) without deleting it.",
          "When you complete a task, choose who did it; that person's coles go down.",
          "Completed: tap one to see its description; the Undo button sends it back to its list and refunds the coles (in case you marked it by mistake).",
          "Coles tab: everyone starts with 100 a month, with the ranking, month-by-month history and the legend of how they're assigned. Each movement can be deleted to fix the scoreboard. It's a studio game.",
  ...
  return [
    ...
    },
    {
      ...
      pasos: [
        ...
        "Bajo cada A4/A3 hay dos botones: rojo (sold out, se agotó) y naranja (falta el sample del stand). Márcalos por talla si aplica.",
    ...
    },
    {
      ...
      pasos: [
        ...
        "Ventas: SumUp (tarjeta), efectivo contado al final (cuenta TODO lo del bolsillo, con el float dentro: la app le resta el float sola, y puede salir negativo si no se cubrió) y PayPal.",
    ...
    },
    {
      ...
      pasos: [
        ...
        "Junto al micrófono, elige el idioma en el que vas a hablar (ES, EN, HI, TE, DE, IT, CA): usa tu idioma nativo, el que te salga natural. Nosotros lo traducimos.",
        "Toca 'Enviar feedback'. Listo: le llega directo a Marcello y Nuria.",
        "Tus feedbacks aparecen en la lista de abajo: toca el lápiz para editar uno si te faltó algo.",
      ],
    ...
    },
    {
      ...
      pasos: [
        ...
        "Pestaña Personal: cada admin ve solo sus mercados (Marcello ve Mauerpark, Nuria ve RAW), con el historial de cada cierre y su desglose. Privado.",
    ...
    },
    {
      ...
      pasos: [
        "Activas: tareas recurrentes de mantenimiento, no se acaban (al completarlas saltan a la siguiente fecha y avisan cuándo vuelven). Puntuales: tareas de un solo uso.",
        "En ambas listas, lo más reciente va arriba y lo atrasado al final. Crea una con el botón verde.",
        "Cada tarea tiene dificultad: simple 1 col, media 2, compleja 3 o 4 (según complejidad y horas).",
        "Toca el lápiz de una tarea para editarla (nombre, frecuencia, dificultad, asignado) sin borrarla.",
        "Al completar una tarea eliges quién la hizo; a esa persona se le restan las coles.",
        "Completadas: toca una para ver su descripción; el botón Deshacer la devuelve a su lista y reintegra las coles (por si la marcaste por error).",
        "Pestaña Coles: cada uno parte con 100 al mes, con el ranking, el historial mes a mes y la leyenda de cómo se asignan. Cada movimiento se puede eliminar para corregir el marcador. Es un juego del estudio.",
